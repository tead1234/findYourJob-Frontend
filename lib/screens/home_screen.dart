          ...
          BlocListener<HomeBloc, HomeState>(
            ...
            listener: (context, state) {
              if (state is RequestState) {
                Navigator.push(
                    context,
                    _createRouteToLoadingScreen(
                        state.imgPath, state.imgBytes, state.gender, state.agreeYn));
              }
            },
  ...
  Route _createRouteToLoadingScreen(
    ...
    return PageRouteBuilder(
      pageBuilder: (context, animation, secondaryAnimation) =>
        ...
        child: BlocProvider(
          create: (context) => WaitingBloc(context.read<KwansangApi>())..add(WaitingScreenInit(imgPath, imgBytes, gender, agreeYn)),
